...
meta() %>%
  meta_description(
    "An e-book for boosting your academic career."
  ) %>% 
  meta_name("github-repo" = "dsquintana/t4scientists") %>% 
  meta_viewport() %>% 
  meta_social(
    title = "Twitter for Scientists",
    url = "https://t4scientists.com/",
    image = "https://raw.githubusercontent.com/dsquintana/t4scientists/master/images/book_cover.png",
...
```{r,echo=FALSE, fig.align='left', out.width='80%', out.height='50%'}
knitr::include_graphics('images/book_cover.png')
```

## Why write a book on Twitter for scientists? {-#why-write-a-book-on-twitter-for-scientists} 

```{r four-ways, echo=FALSE}
tweetrmd::include_tweet("https://twitter.com/dsquintana/status/1105416818791993344?s=20")
```
...
I'm a research scientist at the University of Oslo, in the area of biological psychology. I was awarded my PhD in Psychology in 2013 at the University of Sydney. I now investigate how the hormone oxytocin influences how we think and feel. I'm also interested in cardiac psychophysiology and meta-science, which is the science of scientific practice. Find out more about my research on [my website](https://www.dsquintana.com/). As this is a book about Twitter, you will not be surprised to read that I [tweet a fair bit](https://twitter.com/dsquintana).

I'm the co-host and producer of [*Everything Hertz*](https://everythinghertz.com/), which is a podcast about methodology and scientific life in the biobehavioral sciences. We talk a lot about Twitter on this show, and its role in scientific practice. Many of our episode topics are also inspired by discussions on Twitter. You can also find me on [YouTube](https://www.youtube.com/user/dsquintana85), [Facebook](https://www.facebook.com/dsquintana.research), [Instagram](https://www.instagram.com/dsquintana), [TikTok](https://www.tiktok.com/@dsquintana), and [my blog](https://www.dsquintana.blog/).
...
## Licence {.unlisted .unnumbered}

The online version of this book is licensed under the [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](https://creativecommons.org/licenses/by-nc-sa/4.0/). I am not affiliated with Twitter and all views in this book are mine only (unless it's a tweet authored by someone else).