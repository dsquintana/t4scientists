...
\includegraphics{twitter_book_files/figure-latex/four-ways-1.png}
...
\caption{Using the analytics feature to understand how people are engaging with your tweets}\label{fig:unnamed-chunk-13}
\end{figure}
