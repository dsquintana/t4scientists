...
There is a prestige bias for success in grant applications and manuscript submissions. To thwart this, [several grant agencies now use a lottery system](https://www.nature.com/articles/d41586-019-03572-7) for grant applications and some journals blind the identities of authors to reviewers. But such attempts to reduce prestige bias are not the norm, Those not in a position of privilege have had to disproportionately rely on luck, which is a grim situation.
...
## Fast feedback {.unlisted .unnumbered}
...
```{r, echo=FALSE}
tweetrmd::include_tweet("https://twitter.com/dsquintana/status/1156942188116414465?s=20", hide_thread = TRUE)
```

After posting this, I got feedback from several people, which ranged from the identification of typos to helpful critiques of our central argument. These critiques improved the paper, which is [now published](https://pubmed.ncbi.nlm.nih.gov/32360118/). Perhaps these issues around our central argument would have been caught during peer-review, but when this process is limited to three or four reviewers your chances are slimmer than when you open up critique to everyone.
