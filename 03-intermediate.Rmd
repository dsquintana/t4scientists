...
If you're reading this, you're probably a scientist, so you should understand that Twitter polls are by no means scientific. However, they still provide *some* information and provide a fun alternative to typical text tweets(Figure \@ref(fig:poll)).
...
If you're easily distracted, I would consider [editing your notification settings](https://help.twitter.com/en/managing-your-account/notifications-on-mobile-devices) or turning then off altogether. 