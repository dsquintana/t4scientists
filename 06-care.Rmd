...
## Annoying topics (or users) clogging your feed {.unnumbered}
...
## Spending too much time on Twitter {.unnumbered}
...
Another option is the so-called "soft block". Here, you block someone and then immediately unblock them. By doing this, you force them to unfollow you without making it obvious that they've been blocked (of course, they re-follow again if they notice they're not following you anymore). They will no longer see your tweets in their feed, unless other people retweet you or Twitter's algorithm decides to show them your tweet (this might happen if one of your tweets gets a high level of interaction by people that they follow).

You can report abusive or harmful tweets (or accounts) to Twitter, by following [these instructions](https://help.twitter.com/en/safety-and-security/report-abusive-behavior). 
